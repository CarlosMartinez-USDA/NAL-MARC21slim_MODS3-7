...
xmlns="http://www.loc.gov/mods/v3" xmlns:f="http://functions"
 ...
 2009/11/23 tmee
    ...
    <xsl:template name="marcRecord">
        ...
        <xsl:variable name="physicalDescription">
            ...
            <xsl:apply-templates select="
                    ...
                    | datafield[@tag = '338']/subfield[@code = 'a']" mode="physDesc"/>
            ...
            <xsl:if test="
                ...
                <relatedItem>
                    ...
                    <xsl:for-each
                        ...
                        <!-- identifiers: 1.168 - @76X-78X$x,$w,$z -->
    ...
    <xsl:template name="personal_name">
        ...
        <!--nameIdentifier type="orcID, viaf, lcnaf, etc." -->
        <xsl:for-each-group group-starting-with=".[current()]"
            select="../datafield[@tag = '100' or @tag = '700']/subfield[@code = '1']">
            <nameIdentifier>
...
&lt;/xsl:template&gt;-->
    ...
    <xsl:template name="originInfo">
        ...
        <xsl:variable name="originInfoShared">
            ...
            <xsl:choose>
            <xsl:when test="//datafield[@tag = '260' or @tag = '264']/subfield[@code='b'] = ''">
                <xsl:for-each select="//datafield[@tag = '773']/subfield[@code='d']">
                <publisher>
                ...
                <xsl:otherwise>
                <publisher>
               <xsl:for-each select="//datafield[@tag = '264'][@ind2='0' or @ind2='1' or @ind2='2' or @ind2='3']">
                    <xsl:attribute name="eventType">
                        <xsl:choose>
                            <xsl:when test="@ind2 = '0'">produfction</xsl:when>
