...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	Revision 1.120 - Update relatedItems output to better match mapping. See specific changes below. - 2019/11/20 ws
						...
						1.120 - @800$v a1.120 - @787dd partNumber 800,810, 811, 830 
	...
	Revision 1.49 - Aquifer revision 1.14 - Added 240s (version) data to <titleInfo type="uniform"><xsl:variable name="this">
 2009/11/23 tmee
                ...
                <xsl:when test="//marc:collection/marc:record">
                    <modsCollection xmlns:mods="http://www.loc.gov/mods/v3"
                        ...
                        <xsl:for-each select="//marc:collection/marc:record">
                            <mods xmlns:mods="http://www.loc.gov/mods/v3" version="3.7">
    ...
    <xsl:template name="marcRecord">
		...
		<xsl:for-each select="marc:datafield[@tag=880]">
			<xsl:variable name="related_marc:datafield" select="substring-before(marc:subfield[@code='6'],'-')"/>
			<xsl:variable name="occurence_number" select="substring( substring-after(marc:subfield[@code='6'],'-') , 1 , 2 )"/>
			<xsl:variable name="hit" select="../marc:datafield[@tag=$related_marc:datafield and contains(marc:subfield[@code='6'] , concat('880-' , $occurence_number))]/@tag"/>
...
-->
        ...
        <xsl:variable name="physicalDescription">
            ...
            <xsl:apply-templates select="
                    marc:datafield[@tag = '130']/marc:subfield[@code = 'h'] | marc:datafield[@tag = '240']/marc:subfield[@code = 'h'] |
        ...
        <xsl:choose>
            <xsl:when test="
                ...
                <!-- Cover any physical -->
                <xsl:if test="
                        marc:datafield[@tag = '130'][not(marc:subfield[@code = '6'])][child::*[@code = 'h']] or
                    ...
                    <physicalDescription>
                        ...
                        <xsl:call-template name="reformattingQuality"/>
                        <xsl:apply-templates select="
                                marc:datafield[@tag = '130'][not(marc:subfield[@code = '6'])][child::*[@code = 'h']] |
        ...
        <xsl:for-each select="
                marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '130')]/child::*[@code = 'h'] |
        ...
        <!-- 1.121, 1.135 -->
        <xsl:for-each select="
                marc:datafield[@tag = '501' or @tag = '507' or @tag = '513' or @tag = '514' or @tag = '516'
        ...
        <xsl:for-each
            ...
            <xsl:if
                test="@tag = '440' or (@tag = '880' and not(../marc:datafield[@tag = '440'][@ind1 = '0' or @ind1 = ' '][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '510' or (@tag = '880' and not(../marc:datafield[@tag = '510'][@ind1 = '0' or @ind1 = ' '][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '534' or (@tag = '880' and not(../marc:datafield[@tag = '534'][@ind1 = '0' or @ind1 = ' '][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '700' or (@tag = '880' and not(../marc:datafield[@tag = '700'][marc:subfield[@code = 't']][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <!-- 1.115 -->
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '710' or (@tag = '880' and not(../marc:datafield[@tag = '710'][marc:subfield[@code = 't']][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <!-- 1.115 -->
                    <xsl:if test="marc:subfield[@code = 'i']">
                        <xsl:attribute name="otherType">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '711' or (@tag = '880' and not(../marc:datafield[@tag = '711'][marc:subfield[@code = 't']][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <!-- 1.115 -->
                    <xsl:if test="marc:subfield[@code = 'i']">
                        <xsl:attribute name="otherType">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '730' or (@tag = '880' and not(../marc:datafield[@tag = '730'][@ind2 = 2][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <!-- 1.115 -->
                    <xsl:if test="marc:subfield[@code = 'i']">
                        <xsl:attribute name="otherType">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '740' or (@tag = '880' and not(../marc:datafield[@tag = '740'][@ind2 = 2][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <!-- 1.115 -->
                    <xsl:if test="marc:subfield[@code = 'i']">
                        <xsl:attribute name="otherType">
        ...
        <!-- 1.120 - @777 @787 , 1.121, 1.168 (added914, removed of 787)  -->
        <xsl:for-each select="
                marc:datafield[@tag = '760'] | marc:datafield[@tag = '762'] | marc:datafield[@tag = '765'] |
            ...
            <xsl:if test="
                ...
                <relatedItem>
                    ...
                    <xsl:for-each
                        ...
                        <!-- identifiers -->
                        <xsl:apply-templates select="marc:subfield[@code = 'o']" mode="relatedItemOf"/>
                        <xsl:apply-templates select="marc:subfield[@code = 'x']" mode="relatedItemX"/>
                        <xsl:apply-templates select="marc:datafield[@tag = '914']/marc:subfield[@code = 'a']"
                            mode="relatedItem914"/>
                        <!--  1.120 - @76X-78X$z -->
                        <xsl:apply-templates select="marc:subfield[@code = 'z']" mode="relatedItem"/>
                                ...
                                <part>
                                    ...
                                    <xsl:analyze-string select="." regex="(\d{{4,6}}.\w{{0,4}})(.+)">
                                        <xsl:matching-substring>
                                            ...
                                            <text type="year">
                                                <xsl:value-of
                                                  select="substring-before(regex-group(1), ' ')"/>
                                            </text>
                                            <text type="month">
                                                <xsl:value-of
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '856' or (@tag = '880' and not(../marc:datafield[@tag = '856'][@ind2 = '2'][marc:subfield[@code = 'q']][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <xsl:for-each
        ...
        <xsl:for-each
            ...
            <xsl:variable name="s6" select="substring(normalize-space(marc:subfield[@code = '6']), 5, 2)"/>
            <xsl:if
                test="@tag = '856' or (@tag = '880' and not(../marc:datafield[@tag = '856'][@ind2 = 2][marc:subfield[@code = 'u']][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
                <relatedItem>
                    <location>
                        <url>
                            <xsl:if test="marc:subfield[@code = 'y' or @code = '3']">
        ...
        <recordInfo>
            ...
            <recordOrigin>
                ...
                <xsl:text>&#160;</xsl:text>
                <xsl:value-of select="normalize-space(concat('Transformed on: ', $date))"/>
            </recordOrigin>
    ...
    <xsl:template name="personal_name">     
        ...
        <xsl:for-each select="../marc:datafield[@tag='100' or @tag='700']/marc:subfield[@code='1']">
            <nameIdentifier>
                <xsl:choose>
                    <xsl:when test="matches(../marc:subfield[@code='1'],'orcid|viaf|isni|[a-z0-9]+') = true()">
                        <xsl:attribute name="type" select="replace(string(../marc:subfield[@code = '1']),'(^https?)://(www)?(\w+)((\.\w+)(\.\w+)?(\.\w+)?)/?(\S+)/?(\?uri=)?(.*)','$3')"/>
                    </xsl:when>
                    <xsl:when test="matches(../marc:subfield[@code='1'],'id.loc.gov|id.nlm.nih.gov|lod.nal.usda.gov|agclass.nal.usda.gov|[a-z]+')=true()">
                        <xsl:attribute name="type" select="replace(string(../marc:subfield[@code = '1']),'(^https?)://(www)?(\w+)((\.\w+)(\.\w+)?(\.\w+)?)/?(\S+)/?(\?uri=)?(.*)','$3$4')"/>
                    </xsl:when>
                </xsl:choose>
    ...
    <!--<xd:doc>
        <xd:desc/>
        <xd:param name="selectType"/>
    </xd:doc>
    <xsl:template name="nameIdAttr">
        <xsl:param name="selectType" select="../marc:subfield[@code='1']" tunnel="yes"/>
        <xsl:attribute name="type">
        <xsl:if test="$selectType">
                 <xsl:analyze-string select="$selectType"
                    regex="(^https?)://(www)?(\w+)((\.\w+)(\.\w+)?(\.\w+)?)/?(\S+)/?(\?uri=)?(.*)">
                    <xsl:matching-substring>
    ...
    <!-- Abstract -->
    <!-- <xd:doc>
        <xd:desc><xd:p><xd:b>nameIdentifier @type="$typeValue"</xd:b></xd:p></xd:desc>
        <xd:param name="nameIdUri"/>
    </xd:doc>
    <xsl:template match="//marc:datafield[@tag='100' or @tag='700']/marc:subfield[@code='1']" mode="name_authority">
        <xsl:param name="nameIdUri" as="xs:string"/>
            <xsl:variable name="typeValue" as="xs:string" select="replace($nameIdUri,'(^https?:\/\/)(www.)?(\w+)(\.)(\w+)(\.\w+)?', '$3$4')"/>
                <xsl:choose>
                   <xsl:when test="starts-with($typeValue,'orcid')">
                       <xsl:attribute name="type">     
                       <xsl:text>orcid</xsl:text>
                       </xsl:attribute>
                   </xsl:when>
                   <xsl:when test="starts-with($typeValue,'viaf')">
                       <xsl:attribute name="type">     
                              <xsl:text>viaf</xsl:text>
                           </xsl:attribute>
                   </xsl:when>
                   <xsl:when test="starts-with($typeValue,'id.loc.gov')">
                       <xsl:attribute name="type">
                           <xsl:text>lcnaf</xsl:text>
                       </xsl:attribute>
                   </xsl:when>
                   <xsl:when test="starts-with($typeValue,'lod.nal.usda.gov|agclass.nal.usda.gov')">
                       <xsl:attribute name="type">    
                       <xsl:text>nalt</xsl:text>
                       </xsl:attribute>
                   </xsl:when>
                   <xsl:when test="starts-with($typeValue,'id.nlm.nih.gov')">
                       <xsl:text>mesh</xsl:text>
                   </xsl:when>
                   <xsl:otherwise>                
                    <xsl:analyze-string select="concat(regex-group(3), regex-group(4))" regex="(\w+)(.*)">
                        <xsl:matching-substring>
                            <xsl:attribute name="typeURI">
                            <xsl:choose>
                                <xsl:when test="starts-with(regex-group(3), 'id')">
                                        <xsl:value-of select="concat(regex-group(3),regex-group(4))"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <value-of select="regex-group(3)"/>
                                </xsl:otherwise>
                            </xsl:choose>
                            </xsl:attribute>
                        </xsl:matching-substring>
    ...
    <xd:doc id="relatedItem" scope="component">
        <xd:desc>marc:subfield[@code = 'g']: 1.120 - @76X-78X$g </xd:desc>
    </xd:doc>
    ...
    <xd:doc id="relatedItem" scope="component">
        <xd:desc>marc:subfield[@code = 'n'] | marc:subfield[@code = 'v']: 1.120 - @800$v </xd:desc>
    </xd:doc>
    ...
    <xd:doc id="relatedItem" scope="component">
        <xd:desc>marc:subfield[@code = 'p']: Create related item title part name </xd:desc>
    </xd:doc>
    ...
    <xd:doc id="relatedItemX" scope="component">
        <xd:desc> 1.168 </xd:desc>
    </xd:doc>
    <xsl:template match="marc:subfield[@code = 'x']" mode="relatedItemX">
        <identifier type="issn">
            <!-- 1.168 -->
            <xsl:call-template name="xxs880"/>
            <xsl:apply-templates/>
    ...
    <xd:doc>
        <xd:desc> "Journal-ID number (e.g.,"Journal:jnl54321")/(i.e.,MARC914$a) is mapped into
            [identifier @type]="local"</xd:desc>
    </xd:doc>
    <xsl:template match="marc:datafield[@tag = '914']/marc:subfield[@code = 'a']" mode="relatedItem914">
        <identifier type="local">
            <!-- 1.168 -->
            <xsl:value-of select="../marc:subfield[@code = 'a']"/>
        </identifier>
    ...
    <xsl:template match="marc:subfield[@code = 'o']" mode="relatedItemOf"/>
...
-->
    ...
    <xd:doc>
        <xd:desc>Revision 2.05 controlField008-35-37replace, uses replace function and regex to
            pinpoint 3 letter string</xd:desc>
        <xd:param name="controlField008-35-37p"/>
    </xd:doc>
    <xsl:template name="filteredForLanguage">
        ...
        <xsl:choose>
            ...
            <xsl:when
                test="contains($controlField008-35-37p, $controlField008-35-37v) and matches($controlField008-35-37p, '[a-z]{3}')">
                <language>
                    <languageTerm authority="iso639-2b" type="code">
        ...
        <xsl:for-each
            ...
            <xsl:choose>
                ...
                <xsl:when test="$controlField008-35-37">
                    <xsl:call-template name="filteredForLanguage">
...
-->
    ...
    <xsl:template name="createNameFrom720">
        <!-- 1.91 FLVC correction: the original if test will fail because of xpath: the current node (from the for-each above) is already the 720 marc:datafield -->
...
&lt;/xsl:template&gt;-->
    ...
    <xsl:template name="createNoteFrom910"
        match="marc:datafield[@tag = '910']/marc:subfield[@code = 'a' or @code = 'b']">
    ...
    <xsl:template name="createNoteFrom945"
        match="marc:datafield[@tag = '945']/marc:subfield[@code = 'a' or @code = 'd' or @code = 'e']">
        ...
        <xsl:if test="marc:datafield[@tag = '945']">
            <note type="indexer">
                ...
                <xsl:if test="count(marc:datafield[@tag = '945']/marc:subfield[@code = 'd']) != 0">
                    <xsl:text>&#160;</xsl:text>
    ...
    <xsl:template name="createNoteFrom974" match="//marc:datafield[@tag = '974']">
        ...
        <identifier type="local">
            <!-- $a agid: -->
            <xsl:value-of select="normalize-space(marc:datafield[@tag = '974']/marc:subfield[@code = 'a'])"/>
        </identifier>
    </xsl:template>
    ...
    <xsl:template name="createRelatedItemFrom490">
        ...
        <!-- 1.121 -->
        <xsl:if
            test="@tag = '490' or (@tag = '880' and not(../marc:datafield[@tag = '490'][@ind1 = '0' or @ind1 = ' '][substring(marc:subfield[@code = '6'], 5, 2) = $s6]))">
            <relatedItem type="series">
                <xsl:for-each
    ...
    <xsl:template name="nameTitleGroup">
        <xsl:choose>
            ...
            <xsl:when test="
                    (self::marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '100')]
    ...
    <xd:doc>
        <xd:desc> Form element generated from 130, 240, 242, 245, 246,730 and 256 marc:datafields
        </xd:desc>
    </xd:doc>
    <xsl:template match="
            marc:datafield[@tag = '130']/marc:subfield[@code = 'h']
    ...
    <xsl:template name="originInfo">
        ...
        <xsl:variable name="originInfoShared">
            ...
            <xsl:variable name="marc:controlfield008-7-12">
            ...
            <!--
	Example: <marc:controlfield tag="008">221003s2022 flu 001 0 eng </marc:controlfield> 
    ...
    -->
            ...
            <xsl:choose>
                ...
                <xsl:when
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="contains(., $marc:controlfield008-7-12)">
                            <dateIssued encoding="marc">
                                <xsl:value-of select="$marc:controlfield008-7-12"/>
                            </dateIssued>
                        </xsl:when>
            ...
            <xsl:otherwise>
                <xsl:if
                    ...
                    <originInfo>
                        ...
                        <xsl:apply-templates
                            select="marc:datafield[@tag = '310'] | marc:datafield[@tag = '321']"
                            mode="originInfo"/>
                    </originInfo>
                </xsl:if>
            </xsl:otherwise>
        ...
        <xsl:for-each select="
                marc:datafield[@tag = '880'][starts-with(marc:subfield[@code = '6'], '260')]
