...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:include href="slimUtils.xsl"/>
...
<!--                <xsl:attribute name="type" select="f:name-identifier(../subfield[@code = '1'])"/>-->
...
-->
    ...
    <!--@depreciated - no longer used
        ...
        template name: relatedItem510
        archived 20230112 cm3-->

    <!-- @depreciated - no longer used see 1.121
        template name: relatedItem76X-78X
        archived 20230112 cm3-->
