        ...
        <xsl:result-document encoding="UTF-8" version="1.0" method="xml" media-type="text/xml"
            ...
            <xsl:choose>
                <xsl:when test="//collection/record">
                    <modsCollection xmlns:mods="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <xsl:template name="originInfo">
        ...
        <xsl:variable name="originInfoShared">
            ...
            <xsl:variable name="marcCountryCode">
                <xsl:analyze-string select="$controlField008" regex="(\d+[a-z]\d{{0,8}})(x{{2}}|[a-z]{{3}}|\D+)">
                    <xsl:matching-substring>
                        <xsl:value-of
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="matches($marcCountryCode, '[a-z]{2,3}')">
                        <place>                          
                            ...
                            <!-- 1.167 decodes MARC Country Codes -->
                            <placeTerm>
                                <xsl:attribute name="type">text</xsl:attribute>
