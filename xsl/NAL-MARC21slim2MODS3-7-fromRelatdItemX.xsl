...
<!--                        <xsl:apply-templates select="subfield[@code = 'w']" mode="relatedItem"/>-->
                        <xsl:apply-templates select="subfield[@code = 'a']" mode="relatedItemA"/>
                        
                        <!--  1.120 - @76X-78X$z -->
                        <xsl:apply-templates select="subfield[@code = 'z']" mode="relatedItem"/>
                        <xsl:apply-templates select="subfield[@code = 'w']" mode="relatedItemOf"/>
                        <!--1.170 -->
                        <xsl:if test="@tag = '773'">
    ...
    <xd:doc id="relatedISSN" scope="component">
    ...
    <xd:doc id="relatedLocal" scope="component">
        <xd:desc> 1.120 - @76X-78X$z </xd:desc>
    </xd:doc>
    ...
    <!--&lt;xd:doc id="relatedISSN" scope="component"&gt;
  &lt;xd:desc&gt;&lt;xd:p&gt;1.120 - @76X-78X$z&lt;/xd:p&gt; 
  &lt;xd:p&gt;1.68 - 914$a&lt;/xd:p&gt;
  &lt;/xd:desc&gt;
  &lt;/xd:doc&gt;
  ...
  &lt;/xsl:template&gt;
    ...
    <xsl:template match="subfield[@code = 'a']" mode="relatedItemA">
       <xsl:if test="@tag='914'">
           <identifier type="local">
               <!-- 1.121 -->
               <xsl:call-template name="xxs880"/>
    ...
    <xsl:template match="datafield[@tag = '914']/subfield[@code = 'b']" mode="relatedItemB">
        <identifier type="issn">
            <!-- 1.121 -->
            <xsl:call-template name="xxs880"/>
            <xsl:apply-templates/>
    ...
    <!-- <xd:doc>
        <xd:desc>Journal-ID number</xd:desc>
    </xd:doc>
    <xd:doc id="relatedJournal-ID" scope="component">
...
&lt;/xsl:template&gt;-->
    ...
    <xd:doc>
        <xd:desc>
            <xd:p>The date of record:<xd:b>AGRICOLA Sale File:</xd:b>
            </xd:p>
